...
# Set the webhook URL to the simplified endpoint
WEBHOOK_URL="${CALENDLY_WEBHOOK_URL/\/webhook/\/webhook-simple}"
...
echo "Testing simplified webhook endpoint: ${WEBHOOK_URL}"
echo "Payload:"
echo "${PAYLOAD}" | jq '.'
echo -e "\nSending request..."
